const MainModule = (function () {
    ...
    const WEATHER_API_KEY = '93b7587a55f39ff4f0dc94e189ea5bd3';
    const WEATHER_CITY = 'Pekanbaru'; 
    const WEATHER_ICONS = {
    ...
    async function fetchWeather() {
        ...
        try {
            const response = await fetch(
                `https://api.openweathermap.org/data/2.5/weather?q=${WEATHER_CITY}&units=metric&lang=id&appid=${WEATHER_API_KEY}`
            );
            ...
            const iconClass = WEATHER_ICONS[data.weather[0].main] || 'bi-cloud-sun-fill';
